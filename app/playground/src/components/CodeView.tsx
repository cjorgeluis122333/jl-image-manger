...
export const CodeView: React.FC = () => {
  return (
    <main className="flex-1 max-w-6xl w-full mx-auto p-8 overflow-y-auto">
      <div className="bg-zinc-950/80 border border-zinc-800/80 rounded-3xl p-8 shadow-2xl backdrop-blur">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <FileText className="w-6 h-6 text-blue-400" />
            <div>
              <h2 className="text-xl font-bold text-white tracking-tight">Librería Core Sin Dependencias de Framework</h2>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 overflow-x-auto text-xs font-mono text-zinc-300 leading-relaxed shadow-inner">
